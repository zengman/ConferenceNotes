...
###  5.Extendable NFV-Integrated Control Method Using Reinforcement Learning
NFV，allocation problems, 目前的方法要么不是可扩展的(combined, 参数变化时需要reconstruct the problem formula),要么就是coordinated approach, extendable control 但是no method has beed developed to optimize allocations through this type of coordination.

probose an extendable control method based RL.

>authors:
![](2019-06-14-17-56-53.png)

## 2019.6.17

### 1. Two-stage adaptive Bloom Filters for per-flow monitoring in Software Defined Networks 
